...
export default function Home() {
  ...
  // Nuevos estados para el buscador y filtro
  ...
  // Extraemos las categorías únicas para el menú desplegable
  ...
  return (
    <div style={{ 
      ...
      minHeight: "100vh",
      // Fondo verde oscuro con imagen de plantas de fondo
      ...
      <div style={{ 
        ...
        <div><h1 style={{ margin: 0, fontSize: "1.8rem", letterSpacing: "1px" }}>🌿 Plantas Vita</h1></div>
      ...
      <footer style={{ backgroundColor: "#152b21", color: "#bdc3c7", textAlign: "center", padding: "20px", marginTop: "auto" }}>
        <p style={{ margin: 0 }}>© {new Date().getFullYear()} Plantas Vita - Todos los derechos reservados.</p>
